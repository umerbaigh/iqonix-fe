...
const DepartmentSlider = ({ data }) => {
  ...
  return (
    <div className="my-8 overflow-hidden max-w-[1600px] w-full mx-auto">
          ...
          {data?.map((category) => (
            <div key={category?.id} className="px-2">
              <div className="relative overflow-hidden group">
                ...
                />
                <div className="absolute inset-0 hover:bg-black hover:bg-opacity-30 flex flex-col items-center justify-center transition duration-500 ease-in-out">
